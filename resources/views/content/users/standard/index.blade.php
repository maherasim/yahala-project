...
@section('content')
  ...
  <li class="nav-item" role="presentation">
    ...
    <x-modal id="editModal{{ $user->id }}" title="Edit Standard User" saveBtnText="Update" saveBtnType="submit"
    ...
    <x-modal id="createModal" title="Add Standard User" saveBtnText="Create" saveBtnType="submit"
