...
<ul class="nav nav-tabs nav-fill" role="tablist">
  <li class="nav-item" role="presentation">
    <a type="button" class="nav-link justify-content-start nav-text-left {{ ucfirst($userLevel) == 'Educated' ? 'active' : '' }}" href="{{url('portal/notification-setting')}}" aria-selected="{{ ucfirst($userLevel) == 'Educated' ? 'true' : 'false' }}" tabindex="-1">
  ...
  <li class="nav-item" role="presentation">
    <a type="button" class="nav-link justify-content-start nav-text-left {{ ucfirst($userLevel) == 'Cultivated' ? 'active' : '' }}" href="{{url('/portal/cultivated')}}" aria-selected="{{ ucfirst($userLevel) == 'Cultivated' ? 'true' : 'false' }}" tabindex="-1">
        <div class="d-flex justify-content-start align-items-center">
            <div class="avatar-wrapper">
  ...
  <li class="nav-item" role="presentation">
    <a type="button" class="nav-link justify-content-start nav-text-left {{ ucfirst($userLevel) == 'Academic' ? 'active' : '' }}" href="{{url('/portal/academic')}}" aria-selected="{{ ucfirst($userLevel) == 'Academic' ? 'true' : 'false' }}" tabindex="-1">
        <div class="d-flex justify-content-start align-items-center">
            <div class="avatar-wrapper">
...
<div class="nav-align-left mb-4">
    <ul class="nav nav-tabs" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#Storage" aria-controls="Storage">
                <div class="d-flex justify-content-start align-items-center">
                    <div class="avatar-wrapper">
                        <div class="avatar avatar-sm me-3"><img src="{{asset('assets/userrole/icons/storage.svg')}}" alt="Storage"></div>
                    </div>
                    <div class="d-flex flex-column genos-font">
