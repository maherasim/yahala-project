...
@section('title', 'Users - Cultivated')
...
@section('content')
    ...
    <x-modal id="editModal{{ $user->id }}" title="Edit Premium User" saveBtnText="Update" saveBtnType="submit"
    ...
    <x-modal id="createModal" title="Add Premium User" saveBtnText="Create" saveBtnType="submit"
        saveBtnForm="createForm" size="xl" :show="old('showCreateFormModal') ? true : false">
