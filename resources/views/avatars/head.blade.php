...
<link rel="stylesheet" href="{{asset('/public/assets/vendor/libs/toastr/toastr.css')}}" />
<link rel="stylesheet" href="{{asset('/public/assets/vendor/libs/animate-css/animate.css')}}" />
...
<!-- Page Styles -->
<link rel="stylesheet" href="{{asset('/public/assets/vendor/css/pages/page-icons.css')}}" />
  ...
  <script>
    window.templateCustomizer = new TemplateCustomizer({
      ...
      pathResolver: function(path) {
        var resolvedPaths = {
          // Core stylesheets
                      'core.css': "{{asset('/public/assets/vendor/css/rtl/core.css?id=0286e38248768ef3ef97f053e1fb844e')}}",
            'core-dark.css': "{{asset('/public/assets/vendor/css/rtl/core-dark.css?id=9a1c0d0fa7428bf3d11b21e15f6783c1')}}",
          
          // Themes
                      'theme-default.css': "{{asset('/public/assets/vendor/css/rtl/theme-default.css?id=a2426eee52a0e09728b9fa06cefe0b4b')}}",
            'theme-default-dark.css':
            "{{asset('/public/assets/vendor/css/rtl/theme-default-dark.css?id=ba148a35eca48e183e53bfae0dc8b265')}}",
                      'theme-bordered.css': "{{asset('/public/assets/vendor/css/rtl/theme-bordered.css?id=72085df03150d888ef33d284f592b7cb')}}",
            'theme-bordered-dark.css':
            "{{asset('/public/assets/vendor/css/rtl/theme-bordered-dark.css?id=58d9f2f33a506c99a780317a1cbbe6c7')}}",
                      'theme-semi-dark.css': "{{asset('/public/assets/vendor/css/rtl/theme-semi-dark.css?id=b48dc34aaae1323386aed6029989ad09')}}",
            'theme-semi-dark-dark.css':
            "{{asset('/public/assets/vendor/css/rtl/theme-semi-dark-dark.css?id=f7e984827d3560a67bcc51a41b10b024')}}",
                  }
...
<!--first add-->
  ...
  <li class="menu-item ">
          ...
          <a href="{{url('uploads_cards')}}" class="menu-link">
...
<!--thi add-->
    ...
    <li class="menu-item ">
      ...
      <ul class="menu-sub">
        <li class="menu-item ">
          <a href="https://admin.yekbun.net/settings/countries" class="menu-link">
            <div>Add Country</div>
          </a>
        </li>
        <li class="menu-item  ">
